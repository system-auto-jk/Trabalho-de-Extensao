...
import openpyxl
import os
from tkinter import Frame, Label, Button, Entry, Text, SOLID
root = Tk()
...
class Funcs():
    ...
    def desconecta_db(self):
        ...
        # Mostrar Tabela do banco de dados
    ...
    def Alterar_cliente(self):
        ...
        # Calendário usado para selecionar a data
    def Calendario(self):
        ...
        # Fechar calendário após escolher data.
    def Print_cal(self):
    ...
    def Exportar_Excel(self):
        if self.entry_nome.get() == '':
            ...
            if self.retorno_exportar == True:
                ...
                self.info_excel = self.book['Sheet']
                self.info_excel.append(['ID','Nome','Numero','Email','Nº Processo','Local do Processo','Tipo do Processo','Status','Vara','Observação','Data'])
                self.info_excel.append([f'{self.col1}',f'{self.col2}',f'{self.col3}',f'{self.col4}',f'{self.col5}',f'{self.col6}',f'{self.col7}',f'{self.col8}',f'{self.col9}',f'{self.col10}',f'{self.col11}'])
                
                self.book.save(f'{self.col2}.xlsx')
                os.startfile(f'{self.col2}.xlsx')

# Classe principal - Inicio do programa
class ProgramaAgenda(Funcs):
        # Funções que iniciam junto com o programa 
    def __init__(self):
        self.root = root
        self.montaTabelas()
        self.tela()
        ...
        # Criar Tela / Configuração da Tela
    def tela(self):
        self.root.title('Agenda Advogada')
        self.root.geometry('1300x700')
        self.root.maxsize(width=1350, height=800)
        self.root.minsize(width=850, height=550)
        self.root['bg'] = '#f4f4f4'  # Cor de fundo clara

        # Frames Utilizados na tela
    def Frames_da_tela(self):
        ...
        # Criar os botões / Configuração dos botões
    ...
    def Criar_Lista_T_Processo(self):
        ...
        # Tabela que exibe os clientes cadastrados
